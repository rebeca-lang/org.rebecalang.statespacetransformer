package org.rebecalang.statespacetransformer.prism;
...
public class ProbabilisticRebecaStateSpacePrism extends AbstractStateSpaceXMLDefaultHandler {
	...
	public ProbabilisticRebecaStateSpacePrism(String output, Set<String> observableVariables, Set<StateSpaceTransformingFeature> analysisFeatures) throws FileNotFoundException {
